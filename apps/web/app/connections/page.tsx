...
const statusPill = (status: string) => {
  switch (status) {
    case "active":
      return "border border-[#6366F1]/50 text-[#6366F1] bg-[#6366F1]/10 shadow-[0_0_15px_rgba(212,175,55,0.1)]";
    case "pending_test":
      return "border border-white/30 text-[#F8FAFC] bg-white/5";
    case "test_failed":
      return "border border-[#EF4444]/50 text-[#EF4444] bg-[#EF4444]/10";
    default:
      return "border border-[#374151]/50 text-[#374151] bg-[#374151]/10";
  }
};

const fieldBoxyClass =
  "w-full bg-[#111827] border border-white/10 px-4 py-3 text-[#F8FAFC] text-[13px] focus:outline-none focus:border-[#6366F1]/50 focus:bg-[#1F2937] focus:ring-1 focus:ring-[#6366F1]/30 transition-all rounded-sm placeholder:text-[#374151] disabled:opacity-50 disabled:cursor-not-allowed tracking-wide font-light";
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-16 px-4 py-12 sm:px-8 lg:py-24 animate-fade-in">
        ...
        <header className="flex flex-col gap-12 lg:flex-row lg:items-end lg:justify-between border-b border-white/10 pb-12">
          <div className="max-w-3xl space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-[55ch] text-sm lg:text-base leading-relaxed text-[#94A3B8] font-light">
        ...
        <section className="grid gap-12 lg:gap-24 lg:grid-cols-[1.2fr_0.8fr] animate-fade-in-up [animation-delay:100ms]">
          ...
          <div className="flex flex-col gap-16">
            ...
            <div className="bg-[#111827] p-8 sm:p-12 border border-white/5 relative overflow-hidden group hover:border-white/10 transition-colors">
              <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between mb-10 border-b border-white/5 pb-8">
                <div>
                  <h2 className="text-2xl font-serif text-[#F8FAFC] tracking-wide font-light mb-2">Diagnostic Test</h2>
                  <p className="text-[11px] leading-5 text-[#94A3B8] font-light max-w-[40ch]">
              ...
              <dl className="grid gap-8 sm:grid-cols-2">
                <div className="relative group/dl">
                  <dt className="text-[10px] font-medium uppercase tracking-[0.2em] text-[#374151] mb-2 group-hover/dl:text-[#6366F1] transition-colors">
                    Last Execution
                  </dt>
                  <dt className="sr-only">Last tested</dt>
                  <dd className="text-[13px] font-mono font-light text-[#F8FAFC]">
                ...
                <div className="relative group/dl">
                  ...
                  <dt className="sr-only">Last successful</dt>
                  <dd className="text-[13px] font-mono font-light text-[#F8FAFC]">
              ...
              {connection?.last_error ? (
                <div className="mt-8 border-l-2 border-[#EF4444] bg-[#EF4444]/5 p-5">
                  ...
                  <p className="whitespace-pre-wrap leading-relaxed text-[11px] font-mono text-[#94A3B8]">{connection.last_error}</p>
                </div>
              ) : null}
            </div>

            {/* Credential Rotation */}
            <div className="bg-[#111827] p-8 sm:p-12 border border-white/5 relative">
              <header className="mb-10 pb-8 border-b border-white/5">
                <h2 className="text-2xl font-serif text-[#F8FAFC] tracking-wide font-light mb-2">Vault Rotation Protocol</h2>
                <p className="text-[11px] leading-5 text-[#94A3B8] font-light max-w-[60ch]">
              ...
              <form action={rotateConnectionAction}>
                ...
                <div className="grid gap-8 md:grid-cols-2">
                  <label className="flex flex-col gap-3 group/input">
                    <span className="text-[10px] uppercase tracking-[0.15em] text-[#374151] group-focus-within/input:text-[#6366F1] transition-colors">Tenant Account</span>
                    <input
                      name="rotate_account"
                  ...
                  <label className="flex flex-col gap-3 group/input">
                    <span className="text-[10px] uppercase tracking-[0.15em] text-[#374151] group-focus-within/input:text-[#6366F1] transition-colors">Execution Role</span>
                    <input
                      name="rotate_role"
                      className={fieldBoxyClass}
                  ...
                  <label className="flex flex-col gap-3 group/input md:col-span-2">
                    <span className="text-[10px] uppercase tracking-[0.15em] text-[#374151] group-focus-within/input:text-[#6366F1] transition-colors">Service Username</span>
                    <input
                  ...
                  <div className="md:col-span-2 pt-6 my-2 border-t border-white/5 relative">
                    <span className="absolute -top-3 left-0 bg-[#111827] px-2 text-[10px] uppercase tracking-[0.15em] text-[#374151]">Password Auth</span>
                  </div>

                  <label className="flex flex-col gap-3 group/input md:col-span-2">
                    <span className="text-[10px] uppercase tracking-[0.15em] text-[#374151] group-focus-within/input:text-[#6366F1] transition-colors">Target Password</span>
                    <input
                  ...
                  <div className="md:col-span-2 pt-6 my-2 border-t border-white/5 relative">
                    <span className="absolute -top-3 left-0 bg-[#111827] px-2 text-[10px] uppercase tracking-[0.15em] text-[#374151]">Key-Pair Auth</span>
                  </div>

                  <label className="flex flex-col gap-3 group/input md:col-span-2">
                    <span className="text-[10px] uppercase tracking-[0.15em] text-[#374151] group-focus-within/input:text-[#6366F1] transition-colors">New Key Payload (PEM)</span>
                    <textarea
                  ...
                  <label className="flex flex-col gap-3 group/input md:col-span-2">
                    <span className="text-[10px] uppercase tracking-[0.15em] text-[#374151] group-focus-within/input:text-[#6366F1] transition-colors">PEM Passphrase <span className="opacity-50">(Encrypted variants)</span></span>
                    <input
                ...
                <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between border-t border-white/5 pt-8 mt-8">
                  <p className="text-[10px] uppercase tracking-[0.05em] leading-5 text-[#374151] font-medium max-w-[45ch]">
          ...
          <aside className="relative py-8 lg:py-12 px-2 flex flex-col justify-start">
            ...
            <ol className="space-y-8 text-[13px] font-light text-[#94A3B8] leading-relaxed relative border-l border-white/10 ml-[2px] pl-6 pb-2">
              <li className="relative">
                <span aria-hidden="true" className="absolute -left-[30px] top-1 w-2.5 h-2.5 rounded-full bg-[#1F2937] border border-white/30" />
                <span className="text-[#6366F1] block text-[10px] uppercase tracking-[0.15em] mb-1">Phase Alpha</span>
              ...
              <li className="relative">
                <span aria-hidden="true" className="absolute -left-[30px] top-1 w-2.5 h-2.5 rounded-full bg-[#1F2937] border border-[#6366F1]" />
                <span className="text-[#6366F1] block text-[10px] uppercase tracking-[0.15em] mb-1">Phase Beta</span>
                Run diagnostic simulation. Actuates the provided tokens and confirms systemic handshake.
              </li>
              <li className="relative">
                <span aria-hidden="true" className="absolute -left-[30px] top-1 w-2.5 h-2.5 rounded-full bg-[#1F2937] border border-white/30" />
                <span className="text-[#6366F1] block text-[10px] uppercase tracking-[0.15em] mb-1">Phase Gamma</span>
                Review telemetry. Unsuccessful binds produce sanitized error strings void of critical secrets.
              </li>
            </ol>

            <div className="mt-12 bg-[#6366F1]/5 border border-[#6366F1]/10 p-5 w-full">
              <div className="text-[10px] uppercase tracking-[0.2em] text-[#6366F1] mb-2 font-medium">Security Notice</div>
              <p className="text-[11px] leading-5 text-[#94A3B8] font-light">
