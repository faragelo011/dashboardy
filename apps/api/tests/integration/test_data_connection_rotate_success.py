"""Integration coverage for US3 rotate + promote on successful test."""
...
def test_rotate_then_successful_test_promotes_pending_and_increments_version(
    ...
    # Fake Vault store gives a new pending id.
    ...
    # Fake Vault read returns the pending credential material when asked.
